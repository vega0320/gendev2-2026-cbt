...
PROFILES = {
    ...
    "pediatric_bmi": {
        ...
        "steps": ["키와 체중으로 BMI를 계산한다.", "성별·연령 성장도표에 대입한다.", "비만 정도와 동반질환에 맞춰 체중 유지 또는 감량 계획을 세운다."],
    ...
    "infertility": {
        ...
        "steps": ["월경·과거 임신 및 수술력으로 원인 후보를 좁힌다.", "정액검사와 자궁난관조영술을 함께 읽는다.", "원인에 맞는 배란유도·유착박리·IVF·ICSI를 선택한다."],
